    ...
    return (
        <div className='w-[250px] border-white border-2 rounded-xl'>
            <div className='w-full'>
                <img src={FilmCover} className='rounded-t-xl h-[320px] w-[250px]' />
            </div>

            <div className='w-full bg-bgWhite rounded-b-xl px-4 py-4'>
                <div className='w-full flex justify-between items-center'>
                    <h1 className='text-white font-bold'>Game of Thrones</h1>
                ...
                <div className='w-full flex gap-5 mt-3'>
                    ...
                    <h5 className='text-[12px] font-normal text-white opacity-60'>Rank 128</h5>
                </div>
